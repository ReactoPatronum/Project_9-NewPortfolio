...
const Home: NextPage<{
  ...
  return (
    <div
      className={` ${color} relative transition-all duration-500 text-white h-screen snap-y snap-mandatory overflow-y-scroll overflow-x-hidden z-0 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80`}
    >
      <Head>
        <title>Emre Onur Kaydın</title>
